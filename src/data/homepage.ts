...
export const homepageData: HomepageData = {
    hero: {
        ...
        subtitle: '高橋・狩川研究室では、人間が安全性確保において主要な役割を果たす大規模・複雑システムの安全性向上に向けた実践的な研究を行っています。',
        image: {
            src: city2Unsplash,
            alt: '都市の画像',
        },
    ...
    aboutFeatures: [
        {
            icon: 'mdi:plane-car',
            title: '航空システム、原子力プラント等の大規模複雑システムを対象にした実践的な研究',
            description: '',
        },
        {
            icon: 'mdi:worker',
        ...
        },
        {
            ...
            title: '視覚系情報・心拍変動・脳活動等の生体情報に基づく人間状態推定技術の開発',
            description: '',
        },
        {
            icon: 'mdi:account-multiple-plus',
            title: '主観的リスク認知の考え方に基づく先端技術（AI,原子力）の社会受容に関する研究',
            description: '',
        },
    ],
    youtube: {
